        ...
        <div class="footer-inner">
          <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">视频</span>
							在线视频 &copy; 2020-2099
						</span>
  ...
  export default {
    ...
    methods: {
      ...
      activeSidebar: function (id) {
        // 兄弟菜单(及其子菜单)去掉active样式，自身增加active样式
        $("#" + id).siblings().removeClass("active");
        // next(previous)_siblings前后所有的兄弟标签，sibling第一个兄弟标签
        $("#" + id).siblings().find("li").removeClass("active");
        $("#" + id).addClass("active");

        // 如果有父菜单，父菜单的兄弟菜单去掉open active样式，父亲菜单加上该样式
